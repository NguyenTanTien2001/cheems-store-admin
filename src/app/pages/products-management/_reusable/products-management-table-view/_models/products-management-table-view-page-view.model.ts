...
import { ProductsManagementTableViewResult } from "./products-management-table-view-view-result.model";

export class ProductsManagementTableViewPageViewModel extends GraphQLFormBasedTablePageViewModel {
  constructor(
    public tableViewResult: ProductsManagementTableViewResult = new ProductsManagementTableViewResult,
