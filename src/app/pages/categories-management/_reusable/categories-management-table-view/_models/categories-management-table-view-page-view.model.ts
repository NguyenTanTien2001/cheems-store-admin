...
import { CategoriesManagementTableViewResult } from "./categories-management-table-view-view-result.model";

export class CategoriesManagementTableViewPageViewModel extends GraphQLFormBasedTablePageViewModel {
  constructor(
    public tableViewResult: CategoriesManagementTableViewResult = new CategoriesManagementTableViewResult,
